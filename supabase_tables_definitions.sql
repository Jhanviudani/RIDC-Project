...
-- Step 1: Define policies
CREATE POLICY "Allow insert for anon" ON feedback FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow update for anon" ON feedback FOR UPDATE TO anon USING (true) WITH CHECK (true);
CREATE POLICY "Allow anon to select" ON feedback FOR SELECT TO anon USING (true);
-- 
-- Step 2: Enable RLS
